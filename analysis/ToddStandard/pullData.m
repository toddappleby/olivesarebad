...
splitFactors = ["apertureRadius","stimulusClass"]; %OMS
...
% [splitCell,indexHolder,spikingData,frameTimings,metaData,seed] = makeData(epochs,frameTs,protocolToOpen,splitFactors,4.5,recordingType,parseNewData);
