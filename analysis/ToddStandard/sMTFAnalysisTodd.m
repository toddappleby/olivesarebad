function result = sMTFAnalysisTodd(groupData, binRate, analysisType, allOrAvg, discardCycles)
...
for k = 1 : length(groupData)
    ...
    [F, phase] = frequencyModulation(bData, ...
        binRate, groupData(k).params.temporalFrequency, allOrAvg, 1:2, discardCycles);
